...
runs the entire pipeline over them twice, checks 132 assertions, and prints
`SELF-TEST PASSED: all 132 checks passed.` The process exits 0 on success and 1 on
...
1. `python -m deauth_correlator --self-test` passes, all 132 checks (more, if you added
