...
`SELF-TEST PASSED: all 190 checks passed.` The process exits 0 on success and 1 on
...
1. `python -m deauth_correlator --self-test` passes, all 190 checks (more, if you added
